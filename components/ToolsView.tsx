...
import { EnhancedAISiteInspector } from './EnhancedAISiteInspector';
...
type Tool = 'ai-advisor' | 'bid-generator' | 'cost-estimator' | 'daily-summary' | 'funding-bot' | 'risk-bot' | 'safety-analysis' | 'site-inspector' | 'workforce-planner' | 'resource-scheduler' | 'multimodal-ai' | 'enhanced-inspector' | 'voice-commands';
...
export const ToolsView: React.FC<ToolsViewProps> = ({ user, addToast, setActiveView }) => {
    ...
    const toolDefinitions: ToolConfig[] = [
        ...
        { id: 'multimodal-ai', name: 'Multimodal AI Assistant', description: 'Advanced AI analysis for images, videos, documents, and voice commands.', icon: '🤖', component: <MultimodalAIAssistant user={user} addToast={addToast} />, permission: true },
        { id: 'enhanced-inspector', name: 'Enhanced Site Inspector', description: 'Advanced AI-powered site inspection with comprehensive analysis.', icon: '🔍', component: <EnhancedAISiteInspector user={user} addToast={addToast} onBack={() => setActiveTool(null)} />, permission: true },
        ...
        { id: 'voice-commands', name: 'Voice Commands', description: 'Control the app and get AI responses using voice commands.', icon: '🎤', component: <VoiceCommandInterface user={user} addToast={addToast} onBack={() => setActiveTool(null)} />, permission: true },

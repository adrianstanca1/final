...
export const MiniBarChartComponent: React.FC<MiniBarChartProps> = ({ data, accent = 'primary', emptyLabel }) => {
    if (!data.length) {
...
export const CostBreakdownListComponent: React.FC<CostBreakdownListProps> = ({ data, currency }) => {
...
export const OperationalSignalsComponent: React.FC<OperationalSignalsProps> = ({
    openIncidentsCount,
    highSeverityCount,

...
const NotificationIcon: React.FC<{ type: NotificationType }> = ({ type }) => {
    ...
    switch (type) {
        case NotificationType.INFO:
            return wrapper(
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-label="Info">
        ...
        case NotificationType.SUCCESS:
            return wrapper(
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor" aria-label="Success">
        ...
        case NotificationType.WARNING:
            return wrapper(
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor" aria-label="Warning">
        ...
        case NotificationType.ERROR:
            return wrapper(
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor" aria-label="Error">
        ...
        case NotificationType.APPROVAL_REQUEST:
            return wrapper(
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor" aria-label="Approval Request">
        ...
        case NotificationType.TASK_ASSIGNED:
            return wrapper(
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor" aria-label="Task Assigned">
        ...
        case NotificationType.NEW_MESSAGE:
            return wrapper(
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor" aria-label="New Message">
        ...
        case NotificationType.DOCUMENT_COMMENT:
            return wrapper(
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor" aria-label="Document Comment">
        ...
        case NotificationType.SAFETY_ALERT:
            return wrapper(
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor" aria-label="Safety Alert">
        ...
        default:
            return wrapper(
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-label="Default">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>,
                'bg-slate-100 text-slate-600'
            );
                    ...
                    notifications.map(n => {
                        ...
                        return (
                            <button
                                ...
                                onKeyDown={(e) => e.key === 'Enter' && handleNotificationSelect(n)}
                                className={`flex items-start gap-3 p-4 border-b border-border hover:bg-accent cursor-pointer text-left w-full ${!isRead ? 'bg-primary/10' : ''}`}
                            >

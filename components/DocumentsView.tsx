    ...
    return (
        <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4" onClick={onClose}>
            <Card className="w-full max-w-lg" onClick={e=>e.stopPropagation()}>
                ...
                <input type="file" title="Upload document" onChange={e => setFile(e.target.files?.[0] || null)} />
...
export const DocumentsView: React.FC<DocumentsViewProps> = ({ user, addToast, isOnline, settings }) => {
    ...
    return (
        <div className="space-y-6">
            ...
            <Card>
                <div className="mb-4">
                    <select title="Project selector" value={selectedProjectId} onChange={e => setSelectedProjectId(e.target.value)} className="p-2 border rounded bg-white dark:bg-slate-800">

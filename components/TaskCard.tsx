...
export const TaskCard: React.FC<TaskCardProps> = ({ todo, allTodos, onClick, assignee, user }) => {
    ...
    return (
        <div
            ...
            className={`group relative bg-white p-4 rounded-lg shadow-sm border hover:shadow-md transition-all ${
                isBlocked ? 'opacity-60 cursor-not-allowed bg-slate-50' : 'cursor-pointer'
            } ${

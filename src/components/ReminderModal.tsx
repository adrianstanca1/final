            ...
            <Card className="w-full max-w-md" onClick={e => e.stopPropagation()}>
                ...
                <div className="space-y-4">
                    ...
                    {mode === 'duration' && todo.dueDate && (
                        <select value={duration} onChange={e => setDuration(e.target.value)} className="w-full p-2 border rounded bg-white dark:bg-slate-700" aria-label="Select reminder duration">

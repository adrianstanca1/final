        ...
        <div className="space-y-6">
                    ...
                    {predictionModels.map((model) => (
                        <div key={model.id} className="bg-gradient-to-r from-blue-50 to-purple-50 p-4 rounded-lg border">
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <span className={`text-xs px-2 py-1 rounded-full ${model.accuracy >= 90 ? 'bg-green-100 text-green-800' :
            ...
            <div className="flex space-x-4 border-b">
                {[
                    ...
                    <button
                        key={tab.id}
                        className={`px-4 py-2 border-b-2 font-medium relative ${activeTab === tab.id
                                ...
                                <div key={idx} className="border rounded-lg p-4">
                                    <div className="flex items-center justify-between mb-4">
                                        ...
                                        <div className="text-right">
                                            <span className={`text-2xl font-bold ${trend.trend === 'up' ? 'text-green-600' :
                                ...
                                <div key={idx} className="border rounded-lg p-4">
                                    <div className="flex items-center justify-between mb-3">
                                        ...
                                        <div className="text-right">
                                            ...
                                            <div className="flex items-center gap-1 mt-1">
                                                <span className={`text-xs ${risk.trend === 'increasing' ? 'text-red-600' :
                                    ...
                                    <div className="mt-3 flex justify-between items-center">
                                        <div className="w-full bg-gray-200 rounded-full h-2 mr-4">
                                            <div
                                                className={`h-2 rounded-full ${risk.level === 'high' ? 'bg-red-500' :

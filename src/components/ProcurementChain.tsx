            ...
            return (
              <div key={step} className="flex items-center gap-2">
                <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-all ${
                  isCompleted ? 'bg-green-100 text-green-600 scale-110' :
                ...
                {index < 4 && <div className={`w-8 h-0.5 transition-colors ${
                ...
                <div className="w-20 h-2 bg-gray-200 rounded-full overflow-hidden">
                  <div 
                    className={`h-full transition-all duration-1000 ${
                      confidenceScore >= 85 ? 'bg-green-500 w-full' :
                  ...
                  <div key={collaborator.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="text-right">
                      <p className={`text-xs font-medium ${
                        collaborator.isOnline ? 'text-green-600' : 'text-gray-500'
                      }`}>
      ...
      {selectedTender && analysis && (
        <div className="space-y-4">
          ...
          <div className="flex space-x-4 border-b">
            <button
              className={`px-4 py-2 border-b-2 font-medium relative transition-colors ${
                activeTab === 'analysis'

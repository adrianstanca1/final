...
export type View = 'dashboard' | 'my-day' | 'foreman-dashboard' | 'principal-dashboard' | 'projects' | 'project-detail' | 'all-tasks' | 'map' | 'time' | 'timesheets' | 'documents' | 'safety' | 'financials' | 'users' | 'equipment' | 'templates' | 'tools' | 'audit-log' | 'settings' | 'chat' | 'clients' | 'invoices' | 'todos' | 'procurement-vendors' | 'procurement-pos' | 'procurement-ai' | 'accounts' | 'financial-reports';
...
export type DashboardDataSource = 'backend' | 'mock';

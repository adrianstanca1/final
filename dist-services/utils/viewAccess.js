...
export const getDefaultViewForUser = (user) => {
    switch (user.role) {
        case Role.OPERATIVE:
            return 'my-day';
        case Role.FOREMAN:
...
export const getViewDisplayName = (view) => viewMetadata[view]?.title ?? view;
export const evaluateViewAccess = (user, view) => {
...
export const canAccessView = (user, view) => evaluateViewAccess(user, view).allowed;
//# sourceMappingURL=viewAccess.js.map
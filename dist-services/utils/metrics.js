import { InvoiceStatus, IncidentStatus, IncidentSeverity } from '../types.js';
/**
 ...
 */
export const getSafetyMetrics = (incidents, dateRanges) => {
 ...
 */
export const getFinancialMetrics = (expenses, invoices, dateRanges) => {
    ...
    const paidInvoices = filteredInvoices.filter(i => i.status === InvoiceStatus.PAID &&
        i.issueDate &&
        i.amountPaid &&
        i.amountPaid > 0);

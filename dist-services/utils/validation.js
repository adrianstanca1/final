 ...
 */
export function validateData(schema, data, environment = 'all') {
    try {
 ...
 */
export function validateForEnvironment(input, schema, targetEnvironment = 'all') {
    ...
    if (targetEnvironment === 'all' || targetEnvironment === currentEnvironment) {
        return validateData(schema, input, targetEnvironment);
    }

...
export const initialData = {
    ...
    users: [
        ...
        { id: '1', firstName: 'Samantha', lastName: 'Lee', email: 'sam@constructco.com', role: Role.ADMIN, companyId: '1', avatar: 'https://i.pravatar.cc/150?u=1', phone: '07123456781', password: 'password123', mfaEnabled: false, availability: AvailabilityStatus.AVAILABLE },
        { id: '2', firstName: 'David', lastName: 'Chen', email: 'david@constructco.com', role: Role.PROJECT_MANAGER, companyId: '1', avatar: 'https://i.pravatar.cc/150?u=2', phone: '07123456782', password: 'password123', mfaEnabled: true, availability: AvailabilityStatus.ON_PROJECT },
        { id: '3', firstName: 'Maria', lastName: 'Garcia', email: 'maria@constructco.com', role: Role.FOREMAN, companyId: '1', avatar: 'https://i.pravatar.cc/150?u=3', phone: '07123456783', password: 'password123', mfaEnabled: false, availability: AvailabilityStatus.ON_PROJECT },
        { id: '4', firstName: 'Bob', lastName: 'Williams', email: 'bob@constructco.com', role: Role.OPERATIVE, companyId: '1', avatar: 'https://i.pravatar.cc/150?u=4', phone: '07123456784', password: 'password123', mfaEnabled: false, availability: AvailabilityStatus.ON_PROJECT },
        ...
        { id: '8', firstName: 'Admin', lastName: 'User', email: 'admin@ascladding.com', role: Role.OWNER, companyId: '3', avatar: 'https://i.pravatar.cc/150?u=8', phone: '07123456788', password: 'password123', mfaEnabled: false, availability: AvailabilityStatus.AVAILABLE },
    ] as Partial<User>[],
    projects: [
        {
            id: '101',

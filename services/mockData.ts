...
export const initialData = {
    ...
    users: [
        ...
        { id: '1', firstName: 'Samantha', lastName: 'Lee', username: 'sam.lee', email: 'sam@constructco.com', role: Role.ADMIN, companyId: '1', avatar: 'https://i.pravatar.cc/150?u=1', phone: '07123456781', password: 'password123', mfaEnabled: false },
        { id: '2', firstName: 'David', lastName: 'Chen', username: 'david.chen', email: 'david@constructco.com', role: Role.PROJECT_MANAGER, companyId: '1', avatar: 'https://i.pravatar.cc/150?u=2', phone: '07123456782', password: 'password123', mfaEnabled: true },
        { id: '3', firstName: 'Maria', lastName: 'Garcia', username: 'maria.garcia', email: 'maria@constructco.com', role: Role.FOREMAN, companyId: '1', avatar: 'https://i.pravatar.cc/150?u=3', phone: '07123456783', password: 'password123', mfaEnabled: false },
        { id: '4', firstName: 'Bob', lastName: 'Williams', username: 'bob.williams', email: 'bob@constructco.com', role: Role.OPERATIVE, companyId: '1', avatar: 'https://i.pravatar.cc/150?u=4', phone: '07123456784', password: 'password123', mfaEnabled: false },
        ...
        { id: '7', firstName: 'Carlos', lastName: 'Diaz', username: 'carlos.diaz', email: 'carlos@constructco.com', role: Role.OPERATIVE, companyId: '1', avatar: 'https://i.pravatar.cc/150?u=7', phone: '07123456787', password: 'password123', mfaEnabled: false },
        { id: '8', firstName: 'Admin', lastName: 'User', username: 'platform.owner', email: 'admin@ascladding.com', role: Role.OWNER, companyId: '3', avatar: 'https://i.pravatar.cc/150?u=8', phone: '07123456788', password: 'password123', mfaEnabled: false },
    ] as Partial<User>[],
    projects: [

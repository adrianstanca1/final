...
export const developmentSecretsConfig = {
...
export const productionSecretsConfig = {
    encryptionAlgorithm: 'aes-256-gcm',
...
export const developmentAPIConfig = {
...
export const getManagersConfig = (environment) => {
    const baseConfig = {
        environment,
...
export const getCompleteManagersConfig = (environment = 'development') => {

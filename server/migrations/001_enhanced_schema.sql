-- Migration: Enhanced Multi-tenant Schema
-- Version: 001
-- Description: Complete database schema for ASAgents platform with all required tables

-- Enable foreign key checks
SET FOREIGN_KEY_CHECKS = 1;

-- Create enhanced tenants table (if not exists)
...
-- Create enhanced users table (if not exists)
...
INSERT IGNORE INTO tenants (name, slug, contact_email, plan)
VALUES ('Default Organization', 'default', 'admin@asagents.co.uk', 'enterprise');
...
INSERT IGNORE INTO users (
  ...
  1,
  'admin@asagents.co.uk',
  '$2b$10$dummy.hash.for.initial.setup',
  'System',
  'Administrator',
  'principal_admin',
  'active'
